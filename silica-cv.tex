...
\leftheader{%
  {\LARGE\bfseries\sffamily Silica Kole -- Résumé (Applicant)}

  \makefield{\faEnvelope[regular]}{\texttt{silicaster[at]gmail[dot]com}}
 % \makefield{\faTwitter}{\texttt{@example}}

  \makefield{\faGlobe}{\url{https://silicakole.info}}

  \makefield{\faLinkedin}
  {\url{https://www.linkedin.com/in/thesilipoint/}}
...
\makerubric{Current Research Interests}
